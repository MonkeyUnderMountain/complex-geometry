% !TeX root = metrics-connections-and-curvature.tex
...
Let \(X\) be a complex analytic varieties and \(E \to X\) a locally free sheaf.
...
\Yang{the following need to revise to the version of analytic varieties}
...
For a smooth metric on a line bundle $\calL$, the curvature \Yang{} gives a $(1,1)$-form.
And this form will exactly represent the line bundle in $H^{1,1}$.
...
Then it becomes the theory so-called Chern-Weil theory.
