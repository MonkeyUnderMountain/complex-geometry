...
\begin{proof}
  ...
  Then by the Holomorphic Implicit Function Theorem (\Yang{}),
...
\begin{theorem}
  By theorem of Lelong (\cite[Theorem 3.2.26]{Barlet-Magnusson-2019-ComplexAnalyticCycles}), we can do integral on a complex analytic space.
  \Yang{}
\end{theorem}
\begin{proof}
  \Yang{}
